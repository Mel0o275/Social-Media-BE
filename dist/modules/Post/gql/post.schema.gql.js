    ...
    registerQuery() {
        return {
            postList: {
                ...
                resolve: (parent, args, context) => this.postResolver.postList(parent, args, context)
            }
        };
    }
    registerMutation() {
        return {
            reactOnPost: {
                ...
                resolve: (parent, args, context) => this.postResolver.reactOnPost(parent, args, context)
            }
        };
    }
}
